...
class AppColors {
  ...
  static const Color mainColor = Color.fromARGB(255, 139, 170, 249);
  static const Color backupColor = Color.fromARGB(255, 0, 204, 221);
  ...
  static const Color splashTextColor = Color.fromRGBO(66, 107, 83, 1);
}
